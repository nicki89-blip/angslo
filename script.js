...
const DATASETS = [
  ...
  { id: "combined", name: "Vse enote skupaj (Unit 1 + Unit 2 + Unit 3)",  url: null, combined: ["unit1.json","unit2.json","unit3.json"] },
...
class QuizApp {
  ...
  checkAnswer(btn) {
    ...
    if (isCorrect) {
      ...
      feedback.innerHTML = `❌ Narobe! Pravilen odgovor: <strong>${escapeHtml(correct)}</strong>`;
    }
